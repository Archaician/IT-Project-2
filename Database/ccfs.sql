...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 25, 2019 at 02:07 PM
...
INSERT INTO `schoolyear` (`yearid`, `yearstart`, `yearend`, `totalAtt`, `scfeeID`, `Status`) VALUES
(1, 2019, 2020, 1, NULL, 'Active'),
(2, 2020, 2021, 200, NULL, 'Inactive'),
(3, 2021, 2022, 200, NULL, 'Inactive');
