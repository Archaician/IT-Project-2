...
public class RegistrationPageOneController implements Initializable {
    ...
    private void nextButton(ActionEvent event) throws IOException {
        ...
        String[] studInfo = {"",givenname.getText(),middlename.getText(),
        surname.getText(),gradelvl.getText(),localDate+"",birthplace.getText(),
        gender.getValue(),telephone.getText(),mobile.getText(),
        address.getText(),prevschool.getText()};
        ...
        if (prevschool.getText().isEmpty()) {
            ...
            RegistrationPageTwoController pageTwo = loader.getController();
            
            ImpleEn.addInfo(studInfo);
